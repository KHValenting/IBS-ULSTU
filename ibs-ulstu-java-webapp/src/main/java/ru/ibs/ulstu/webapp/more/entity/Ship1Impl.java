 ...
 */
public class Ship1Impl implements Ship{
    ...
    public Ship1Impl(int id, String name, String nameLat, String callSign, String imo, String mmsi, Boolean dangerCargo,
    ...
    public String toString() {
        ...
        builder.append("Ship [id=").append(id).append(", name=").append(name).append(", nameLat=").append(nameLat)
