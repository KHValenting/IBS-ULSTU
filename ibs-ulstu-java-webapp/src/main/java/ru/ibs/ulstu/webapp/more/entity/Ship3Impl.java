 ...
 */
public class Ship3Impl extends Entity implements Ship{
    ...
    public Ship3Impl(/*int id,*/ String name, String nameLat, String callSign, String imo, String mmsi, Boolean dangerCargo,
